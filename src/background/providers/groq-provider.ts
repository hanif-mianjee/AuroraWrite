...
export class GroqProvider extends BaseProvider {
  ...
  readonly config: LLMProviderConfig = {
    ...
    models: [
      { id: 'llama-3.1-8b-instant', name: 'Llama 3.1 8B (Fast) (Free)' },
      { id: 'llama-3.3-70b-versatile', name: 'Llama 3.3 70B (Best Quality) (Free)' },
      { id: 'meta-llama/llama-4-scout-17b-16e-instruct', name: 'Llama 4 Scout 17B (Free)' },
